  ...
  return (
   <main className="bg-purple-100">
    ...
    <div className=" flex flex-col gap-4 items-center justify-center">
      ...
      <p className="px-24 text-center">We are the most starightforward URL shortener in the world. Most of the URL shorteners will track you or ask you to give your details for login. We understand your needs and hence we have created this URL shortener</p>
